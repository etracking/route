...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [12623047.008323, 2529134.514080, 12748722.022823, 2582589.833711], maxZoom: 18, minZoom: 7
    })
});
...
map.getView().fit([12623047.008323, 2529134.514080, 12748722.022823, 2582589.833711], map.getSize());
