...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [12639942.765063, 2531085.009033, 12759793.729015, 2581998.412160], maxZoom: 18, minZoom: 7
    })
});
...
map.getView().fit([12639942.765063, 2531085.009033, 12759793.729015, 2581998.412160], map.getSize());
